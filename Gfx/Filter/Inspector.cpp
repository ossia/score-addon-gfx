    ...
    : InspectorWidgetDelegate_T{object, parent}
{
  ...
  connect(edit, &JSEdit::textChanged,
          this, [&object, &context, edit] {
    context.dispatcher.submit<ChangeFragmentShader>(object, edit->toPlainText());
  });
  connect(edit, &JSEdit::editingFinished,
          this, [&object, &context] (const QString& txt) {
