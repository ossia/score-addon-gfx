...
template <>
SCORE_LIB_PROCESS_EXPORT void
JSONObjectReader::read<Gfx::TextureInlet>(const Gfx::TextureInlet& p)
{
  // read((Process::Outlet&)p);
}
template <>
...
template <>
SCORE_LIB_PROCESS_EXPORT void
JSONObjectReader::read<Gfx::TextureOutlet>(const Gfx::TextureOutlet& p)
{
  // read((Process::Outlet&)p);
}
template <>
SCORE_LIB_PROCESS_EXPORT void
JSONObjectWriter::write<Gfx::TextureOutlet>(Gfx::TextureOutlet& p)
{
}
